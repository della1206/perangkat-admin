...
<body class="bg-gray-100 flex h-screen">
    ...
    <aside class="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-1 p-4">
            <ul class="space-y-3">
                <li><a href="{{ route('dashboard.index') }}" class="block p-2 rounded hover:bg-gray-700 {{ request()->routeIs('dashboard.*') ? 'bg-gray-700' : '' }}">🏠 Dashboard</a></li>
                <li><a href="{{ route('user.index') }}" class="block p-2 rounded hover:bg-gray-700 {{ request()->routeIs('user.*') ? 'bg-gray-700' : '' }}">👩🏻‍🦰 User</a></li>
                <li><a href="{{ route('warga.index') }}" class="block p-2 rounded hover:bg-gray-700 {{ request()->routeIs('warga.*') ? 'bg-gray-700' : '' }}">👨‍👩‍👧‍👦 Warga</a></li>
                <li><a href="{{ route('lembaga.index') }}" class="block p-2 rounded hover:bg-gray-700 {{ request()->routeIs('lembaga.*') ? 'bg-gray-700' : '' }}">🏢 Lembaga Desa</a></li>
            </ul>
        </nav>
            ...
            <div class="flex items-center space-x-6">
                ...
                <div id="profileDropdown" class="absolute right-6 mt-32 w-48 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50">
                    <div class="p-4 border-b border-gray-200">
                        <p class="font-medium text-gray-800">{{ auth()->user()->name ?? 'Admin Desa' }}</p>
