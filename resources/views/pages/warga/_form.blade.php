<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="jenis_kelamin" class="w-full border border-gray-300 rounded p-2 focus:ring focus:ring-blue-200 @error('jenis_kelamin') border-red-500 @enderror" required>
        ...
        <div>
            ...
            <select name="agama" class="w-full border border-gray-300 rounded p-2 focus:ring focus:ring-blue-200 @error('agama') border-red-500 @enderror" required>
