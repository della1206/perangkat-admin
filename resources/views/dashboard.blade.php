...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-gray-50 p-8 rounded-lg mb-8">
        <h2 class="text-2xl font-bold mb-2">Selamat Datang di Sistem Perangkat Desa 👋</h2>
     ...
     <!-- PERANGKAT DESA DALAM AKSI SECTION - GAMBAR BESAR -->
                        ...
                        <div class="border-t border-gray-100 pt-6">
                           <p class="text-gray-700 mb-4 font-bold">Hubungi Saya:</p>
                            <div class="flex justify-center lg:justify-start space-x-4">
                               ...
                               <a href="https://www.instagram.com/najwa.alyahh?igsh=MThkdmpkaWxybzRodA=="
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    class="social-icon bg-gradient-to-r from-pink-500 to-purple-600 text-white p-3 rounded-full hover:from-pink-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-start space-x-6">
                ...
                <div class="flex-grow">
                    ...
                    <p class="text-gray-700 mb-6 text-lg leading-relaxed">
                        Sistem Perangkat Desa dikembangkan dengan teknologi modern untuk memastikan performa optimal, keamanan data, dan pengalaman pengguna yang baik.
                    </p>
                    <div class="flex flex-wrap gap-3">
                        <span class="px-7 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg text-sm font-bold shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                            Laravel 10
                        </span>
